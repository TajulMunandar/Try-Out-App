          ...
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center">
              <a class="navbar-brand fw-bold fs-5" href="/">
                <span class="merek">Try </span>Out App
              </a>
            </div>
            <!-- /Logo -->
            ...
            <form id="formAuthentication" action="/login" method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nim') is-invalid @enderror" id="nim" name="nim" placeholder="2020349021" autofocus />
                @error('nim')
